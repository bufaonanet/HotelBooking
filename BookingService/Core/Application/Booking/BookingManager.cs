...
public class BookingManager : IBookingManager
{
    ...
    public async Task<BookingResponse> CreateBookingAsync(BookingDto bookingDto)
    {
        try
        {
            var booking = BookingDto.MapToEntity(bookingDto);
            booking.Guest = await _guestRepository.GetAsync(bookingDto.GuestId);
            booking.Room = await _roomRepository.GetAsync(bookingDto.RoomId);
